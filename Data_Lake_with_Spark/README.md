...
In this project we build an ETL pipeline that extracts the data from S3, processes them using Spark on an EMR cluster, and loads the data back into S3 as a set of dimensional tables in parquet format. 
